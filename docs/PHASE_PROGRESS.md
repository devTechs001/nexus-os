...
### Low
1. Hardware GPU acceleration not yet implemented (software fallback works)
2. Some SMART attributes need vendor-specific decoding
3. Storage Manager UI graph widgets need implementation
